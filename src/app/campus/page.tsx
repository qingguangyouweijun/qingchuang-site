...
import { BookOpen, Package, ReceiptText, Wallet } from 'lucide-react'
      ...
      <MainLayout>
        <div className="max-w-6xl mx-auto py-8 space-y-8">
          <section className="grid grid-cols-1 xl:grid-cols-[1.5fr_1fr] gap-6">
            <Card className="border-none shadow-xl bg-gradient-to-br from-orange-500 to-rose-600 text-white">
              <CardContent className="p-8 space-y-5">
                ...
                <div>
                  ...
                  <p className="text-white/85 mt-3 leading-7 max-w-2xl">
                    统一账号已经接入校园快递代取、旧书广场、校园钱包和管理员独立后台。
                    普通用户默认注册即开通，管理员账号单独区分。
                  </p>
                </div>
