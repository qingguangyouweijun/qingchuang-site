...
export default function ProfileWalletClient({ initialData }: { initialData: WalletData }) {
        ...
        <Card className="border-none shadow-lg">
          ...
          <CardContent>
            <form onSubmit={(event) => void handleSubmit(event)} className="space-y-5">
              ...
              <Button type="submit" disabled={isSubmitting || available <= 0} className="w-full sm:w-auto">
