...
export type ExpressOrderStatus = 'PENDING_PAYMENT' | 'OPEN' | 'ACCEPTED' | 'PICKED_UP' | 'DELIVERED' | 'COMPLETED'
export type BookPostStatus = 'ON_SALE' | 'LOCKED' | 'SOLD' | 'OFF_SHELF'
export type BookOrderStatus = 'PENDING_PAYMENT' | 'WAITING_SELLER' | 'DELIVERED' | 'COMPLETED'
export type SettlementStatus = 'PENDING' | 'APPROVED' | 'REJECTED'
export type CampusBizType = 'EXPRESS_ORDER' | 'BOOK_ORDER'
